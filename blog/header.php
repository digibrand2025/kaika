    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 bg-transparent">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div id="nav-links" class="hidden md:flex items-center space-x-8 text-white transition-colors duration-300">
                    ...
                    <a href="index.php" class="text-sm font-medium hover:text-brand-red transition-colors uppercase tracking-widest relative group <?php echo ($current_page == 'blog') ? 'text-brand-red' : ''; ?>">
                        News
        ...
        <div id="mobile-menu" class="hidden md:hidden absolute top-20 left-0 w-full bg-white shadow-xl border-b border-slate-100 p-6 animate-fade-in-up">
            <div class="flex flex-col space-y-4">
                ...
                <a href="../our-company.php" class="text-slate-800 font-bold hover:text-brand-red <?php echo ($current_page == 'companies') ? 'text-brand-red' : ''; ?>">COMPANIES</a>
                ...
                <a href="index.php" class="text-slate-800 font-bold hover:text-brand-red <?php echo ($current_page == 'blog') ? 'text-brand-red' : ''; ?>">NEWS</a>
